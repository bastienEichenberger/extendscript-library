/*
 * An imported bitmap image in any bitmap file format &amp;&#35;40;including TIFF, JPEG, or GIF&#41;.
 */
var Image = {
  /*
   ...
   */
  imageRenderingIntent: undefined,
 ...
 *
   ...
   * @param {Object} [withProperties] Initial values for properties of the new Image 
   * @returns {Asset}
   */
 ...
 *
   ...
   * @param {Mixed} [around] The point around which to flip the Image. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
 ...
 *
   * @param {Mixed} [to] The location of the new Image, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Mixed} [by] Amount by which to offset the new Image from the original Image's position. 
   * @returns {PageItem}
   */
 ...
 *
   * @param {Mixed} [to] The new location of the Image,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Mixed} [by] The amount (in measurement units) to move the Image relative to its current position, in the format (x, y). 
   */
  move: function(to, by) {
  },
 ...
 *
   ...
   * @param {Boolean} [clearingOverrides] If true, clears the Image's existing attributes before applying the style. 
   * @param {Boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the Image that are not defined in the object style. 
   */
 ...
 *
   ...
   * @param {String} [withProperties] Initial values for properties of the new Image. Above parameters can also be passed as properties 
   */
 ...
 *
   ...
   * Selects the object.
 *
   * @param {SelectionOptions} [existingSelection] The selection status of the Image in relation to previously selected objects. 
   */
