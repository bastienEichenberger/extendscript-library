...
var GraphicLine = {
  ...
  /*
   * The parent of the GraphicLine (a ComboBox, ListBox, TextBox, SignatureField, Spread, MasterSpread, SplineItem, Polygon, GraphicLine, Rectangle, Oval, Group, State, Character, PlaceGun or Snippet).
   * @type {Mixed}
   */
  parent: undefined,
 ...
 *
   ...
   * @param {Mixed} [around] The point around which to flip the GraphicLine. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
 ...
 *
   * @param {Mixed} [to] The location of the new GraphicLine, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Mixed} [by] Amount by which to offset the new GraphicLine from the original GraphicLine's position. 
   * @returns {PageItem}
   */
 ...
 *
   * @param {Mixed} [to] The new location of the GraphicLine,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Mixed} [by] The amount (in measurement units) to move the GraphicLine relative to its current position, in the format (x, y). 
   */
  move: function(to, by) {
  },
 ...
 *
   ...
   * @param {Boolean} [clearingOverrides] If true, clears the GraphicLine's existing attributes before applying the style. 
   * @param {Boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the GraphicLine that are not defined in the object style. 
   */
 ...
 *
   ...
   * @param {String} [withProperties] Initial values for properties of the new GraphicLine. Above parameters can also be passed as properties 
   */
 ...
 *
   ...
   * Selects the object.
 *
   * @param {SelectionOptions} [existingSelection] The selection status of the GraphicLine in relation to previously selected objects. 
   */
