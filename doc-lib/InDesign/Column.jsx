 ...
 *
   ...
   * @param {Mixed} [thru] The last Column in the range. Can accept: Cell, Column or Row. 
   */
   ...
   * Selects the object.
 *
   * @param {SelectionOptions} [existingSelection] The selection status of the Column in relation to previously selected objects. 
   */
