 ...
 *
   ...
   * @param {Mixed} [around] The point around which to flip the ComboBox. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
 ...
 *
   * @param {Mixed} [to] The location of the new ComboBox, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Mixed} [by] Amount by which to offset the new ComboBox from the original ComboBox's position. 
   * @returns {PageItem}
   */
 ...
 *
   * @param {Mixed} [to] The new location of the ComboBox,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Mixed} [by] The amount (in measurement units) to move the ComboBox relative to its current position, in the format (x, y). 
   */
  move: function(to, by) {
  },
