 ...
 *
   ...
   * @param {String} [withProperties] Initial values for properties of the new TextStyleRange. Above parameters can also be passed as properties 
   */
 ...
 *
   ...
   * Selects the object.
 *
   * @param {SelectionOptions} [existingSelection] The selection status of the TextStyleRange in relation to previously selected objects. 
   */
