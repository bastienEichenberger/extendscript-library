 ...
 *
   * @param {Mixed} [to] The new location of the Sound,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Mixed} [by] The amount (in measurement units) to move the Sound relative to its current position, in the format (x, y). 
   */
  move: function(to, by) {
  },
 ...
 *
   ...
   * @param {Mixed} [around] The point around which to flip the Sound. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
