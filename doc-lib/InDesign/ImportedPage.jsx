 ...
 *
   ...
   * @param {Mixed} [around] The point around which to flip the ImportedPage. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
 ...
 *
   * @param {Mixed} [to] The location of the new ImportedPage, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Mixed} [by] Amount by which to offset the new ImportedPage from the original ImportedPage's position. 
   * @returns {PageItem}
   */
 ...
 *
   * @param {Mixed} [to] The new location of the ImportedPage,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Mixed} [by] The amount (in measurement units) to move the ImportedPage relative to its current position, in the format (x, y). 
   */
  move: function(to, by) {
  },
 ...
 *
   ...
   * @param {Boolean} [clearingOverrides] If true, clears the ImportedPage's existing attributes before applying the style. 
   * @param {Boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the ImportedPage that are not defined in the object style. 
   */
 ...
 *
   ...
   * @param {String} [withProperties] Initial values for properties of the new ImportedPage. Above parameters can also be passed as properties 
   */
 ...
 *
   ...
   * Selects the object.
 *
   * @param {SelectionOptions} [existingSelection] The selection status of the ImportedPage in relation to previously selected objects. 
   */
